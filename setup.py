...
setup(
    ...
    entry_points={"console_scripts": ("excovis = excovis.cli:main",)},
    description="Exome coverage visualisation",
    install_requires=install_requirements,
    license="MIT license",
    long_description=readme + "\n\n" + history,
    include_package_data=True,
    keywords="exome sequencing, depth of coverage, visualisation, bioinformatics",
    name="excovis",
    packages=find_packages(include=["excovis"]),
    test_suite="tests",
    tests_require=test_requirements,
    url="https://github.com/bihealth/excovis",
